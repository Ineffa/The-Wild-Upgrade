...
public class UsedBycocketFlairCriterion extends AbstractCriterion<UsedBycocketFlairCriterion.Conditions> {

    private static final Identifier ID = new Identifier(WondrousWilds.MOD_ID, "used_bycocket_flair");
