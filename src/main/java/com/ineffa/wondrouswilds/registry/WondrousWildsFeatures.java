...
public class WondrousWildsFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> FLOWER_FOREST_COARSE_DIRT_SPLOTCH_PLACED = registerPlaced("flower_forest_coarse_dirt_splotch", SMALL_COARSE_DIRT_SPLOTCH_CONFIGURED, RarityFilterPlacementModifier.of(2), CountPlacementModifier.of(BiasedToBottomIntProvider.create(0, 2)), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
    ...
    public static final RegistryEntry<PlacedFeature> FLOWER_FOREST_FALLEN_LOG_PLACED = registerPlaced("flower_forest_fallen_log", FOREST_FALLEN_LOG_CONFIGURED, Stream.concat(VegetationPlacedFeatures.modifiers(RarityFilterPlacementModifier.of(56)).stream(), Stream.of(BlockFilterPlacementModifier.of(BlockPredicate.not(BlockPredicate.matchingBlocks(Direction.DOWN.getVector(), Blocks.MOSS_BLOCK))))).toList());
    ...
    public static final RegistryEntry<PlacedFeature> FLOWER_FOREST_BUSHES_PLACED = registerPlaced("flower_forest_bushes", BUSHES_CONFIGURED, RarityFilterPlacementModifier.of(7), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
